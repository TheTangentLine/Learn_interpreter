...
```
go run ./internal/cmd/main.go program.dot
```
...
| Object Types  | 4/10           | Defining the runtime value system. Mostly boilerplate, but you need to understand _why_ `ReturnValue` and `Error` need to be objects.                                           |
